...
NEGATE = [t.strip() for t in open('/home/amp/Documentos/ds-studies/machine-learning/cases/nlp/sentiment_analysis/lexicons/negate.txt')]

# Booster/dampener 'intensifiers' or 'degree adverbs' (Portuguese)
boosters = []
for l in open('/home/amp/Documentos/ds-studies/machine-learning/cases/nlp/sentiment_analysis/lexicons/booster.txt'):
    parts = l.strip().split(' ')
...
class SentimentIntensityAnalyzer(object):
    ...
    def __init__(self, lexicon_file="/home/amp/Documentos/ds-studies/machine-learning/cases/nlp/sentiment_analysis/lexicons/vader_lexicon_ptbr.txt", emoji_lexicon="/home/amp/Documentos/ds-studies/machine-learning/cases/nlp/sentiment_analysis/lexicons/emoji_utf8_lexicon_ptbr.txt"):
